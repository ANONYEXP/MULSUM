...
def tokenize_raw_data(raw_data_path, token_data_path, rev_dic_path,
    ...
    for item in pbar:
        ...
        parser_dict=_truncate_ast_by_code(parser,3,min(len(parser.code_tokens)-1,3+max_code_len),max_graph_size=max_graph_size,max_code_len=max_code_len,max_nleaf_num=max_nleaf_num,renew_pos=False)
